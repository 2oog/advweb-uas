...
LINE_WIDTH = 32
URL_BASE = "http://localhost/advweb-uas/api"
...
def print_receipt(order: dict):
    ...
    # "order_date": "2025-12-13T13:37:01.000000Z",
    thermal.textln("Tgl   : " + pendulum.parse(order["order_date"]).in_timezone("Asia/Jakarta").strftime("%d-%m-%Y %H:%M:%S"))
    hr()
    ...
    thermal.textln(left_right(str(order.get("payment_method", "QRIS")), fmt_int(order.get("total_amount", 0), sep=".")))
    hr()
